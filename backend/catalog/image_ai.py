...
#: Про выдуманные надписи сказано отдельно и прямо: разрешение «то, что
#: напечатано на нашей посуде, оставь как есть» модель понимает как
#: позволение печать дорисовать — на проверке без образца она сочинила
#: стакану несуществующий логотип. Гостю такое показывать нельзя: это
#: чужой бренд на нашей посуде.
_FORBIDDEN = (
    "Без посторонних надписей, ценников, чужих логотипов и водяных знаков; "
    "то, что напечатано на нашей посуде, оставь как есть. Не придумывай "
    "надписей, эмблем и логотипов, которых нет на приложенном образце: "
    "если на посуде ничего не напечатано, она остаётся чистой. Без людей "
    "и рук в кадре. Естественные цвета, реалистичная порция — столько, "
    "сколько правда помещается в эту посуду."
)
