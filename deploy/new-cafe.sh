...
# Эквайринг: банк и его ключи владелец заводит сам, в панели («Оплата
# картой»). Переменные ниже — запасной путь для этой отдельной установки:
# на ней заведение одно, и общий ключ ничему не мешает.
TBANK_TERMINAL_KEY=
TBANK_PASSWORD=
SBER_USERNAME=
SBER_PASSWORD=
